...
namespace XLua.CSObjectWrap
{
    ...
    public class TutorialDrivenClassWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "ComplexFunc1", _m_ComplexFunc1_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ComplexFunc1_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.RaycastHit p3;
                    
                        double __cl_gen_ret = Tutorial.DrivenClass.ComplexFunc1( i, out p3 );
                        LuaAPI.lua_pushnumber(L, __cl_gen_ret);
